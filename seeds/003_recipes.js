...
export async function seed(knex) {
  ...
  await knex("recipes").insert([
    // Espresso
    { product_id: 1, ingredient_id: 3, quantity_needed: 5, unit: "GM" },
    { product_id: 1, ingredient_id: 1, quantity_needed: 100, unit: "ML" },

    // Flat White
    { product_id: 2, ingredient_id: 1, quantity_needed: 200, unit: "ML" },
    { product_id: 2, ingredient_id: 3, quantity_needed: 80, unit: "GM" },

    // Americano
    { product_id: 3, ingredient_id: 1, quantity_needed: 100, unit: "GM" },
    { product_id: 3, ingredient_id: 2, quantity_needed: 10, unit: "GM" },

    // Matcha Latte
    { product_id: 4, ingredient_id: 4, quantity_needed: 3, unit: "GM" },
    { product_id: 4, ingredient_id: 1, quantity_needed: 100, unit: "ML" },
    { product_id: 4, ingredient_id: 2, quantity_needed: 2, unit: "GM" },

    // Hot Chocolate
    { product_id: 5, ingredient_id: 7, quantity_needed: 10, unit: "GM" },
    { product_id: 5, ingredient_id: 1, quantity_needed: 100, unit: "ML" },
    ...
    { product_id: 6, ingredient_id: 1, quantity_needed: 100, unit: "ML" },
  ]);
}
